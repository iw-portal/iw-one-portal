...
import ProgramLeadSidebar from "./ProgramLeadSidebar";
import { FaBars } from "react-icons/fa";

const ProgramLedLayout = ({ children, setUser }) => {
  const [open, setOpen] = useState(false);

  return (
    <div className="min-h-screen bg-gray-100 flex">
      {/* Sidebar (handles both mobile + desktop internally) */}
      <ProgramLeadSidebar open={open} setOpen={setOpen} setUser={setUser} />
...
export default ProgramLedLayout;
