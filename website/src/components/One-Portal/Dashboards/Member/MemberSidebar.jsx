...
const MemberSidebar = ({ setUser }) => {
  ...
  const links = [
    {
      to: "/one-portal/member",
      label: "Dashboard",
      end: true,
      icon: <MdHome />,
    },
    {
      to: "/one-portal/member/profile",
      label: "Profile",
      icon: <CgProfile />,
    },
    // {
    //   to: "/one-portal/member/registration",
    //   label: "Registration",
    //   icon: <GoPencil />,
    // },
    // {
    //   to: "/one-portal/member/programs",
    //   label: "Programs",
    //   end: true,
    //   icon: <TbFolders />,
    // },
    {
      to: "/one-portal/member/enrollment",
      label: "Program Registration",
      icon: <GrSchedules />,
    },
    {
      to: "/one-portal/member/classes",
      label: "My Classes",
      icon: <HiAcademicCap />,
    },
    {
      to: "/one-portal/member/attendance",
      label: "Attendance",
      icon: <LuMapPinCheckInside />,
    },
    {
      to: "/one-portal/member/transactions",
      label: "Transactions",
      icon: <BsFillCreditCard2FrontFill />,
    },
    // {
    //   to: "/one-portal/member/surveys",
    //   label: "Surveys",
    //   icon: <FcSurvey />,
    // },
    {
      to: "/one-portal/member/opd-review",
      label: "My OPD",
      icon: <HiDocumentText />,
    },
    {
      label: "OPD Directory",
      to: "/one-portal/member/opds",
