...
const ClassesSchedule = ({ user }) => {
  ...
  if (isPaidUser && !hasAssignedClasses) {
    return (
      <div className="bg-white rounded-2xl shadow p-10 text-center">
        <h2 className="text-2xl font-semibold text-[#0f5b54]">
          Class Assignments Pending
        </h2>

        <p className="mt-3 text-gray-500 max-w-xl mx-auto">
          Your registration has been received and payment has been completed.
          Program assignments are currently under review and will appear here
          once finalized by the Inclusive World team.
        </p>
      </div>
    );
  }
