...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { email, fname, lname, decision, application_id, rejection_reason } =
      req.body;
    ...
    const subject = approved
      ? `Inclusive World Member Application Approved`
      : `Inclusive World Member Application Update`;
    ...
    <tr>
      <td bgcolor="#0c4f49" align="center" style="padding:50px 36px;">
        ...
        <div style="color:#d7efeb; font-size:16px; line-height:28px; margin-top:22px; max-width:470px;">
          Your membership application has officially been approved and we are excited to welcome you into the Inclusive World community.
        </div>
    ...
    <tr>
      <td style="padding:42px 36px;">
        ...
        <div style="color:#5d6c69; font-size:16px; line-height:30px;">
          Congratulations on your successful membership approval. We are excited to have you become part of a growing community focused on accessibility, empowerment, learning, and inclusion.
        </div>
          ...
          <tr>
            <td style="padding:28px;">
              ...
              <div style="color:#0c4f49; font-size:20px; font-weight:bold; margin-bottom:12px;">
                Your Member Access Includes
              </div>

              <div style="color:#61706d; font-size:15px; line-height:30px;">
                • Access to the Inclusive World One Portal<br />
                • Community programs and activities<br />
                • Learning and collaboration opportunities<br />
                • Member announcements and updates<br />
          ...
          <tr>
            <td align="center">
              ...
              <a
                ...
                "
              >
                Create Your One Portal Account
              </a>
        ...
        <div style="margin-top:42px; color:#667572; font-size:15px; line-height:28px;">
          Thank you for joining Inclusive World. We look forward to building meaningful impact together and are excited to have you as part of our member community.
        </div>
        ...
        <tr>
          ...
          >
            ...
            <div
              ...
              "
            >
              We sincerely appreciate your interest in becoming part of Inclusive World.
            </div>
        ...
        <tr>
          <td style="padding:42px 36px;">
            ...
            <div
              ...
              "
            >
              After careful consideration, we regret to inform you that we are unable to move forward with your membership application at this time.
            </div>
  ...
  >
    ${rejection_reason}
            ...
            <div
              ...
              "
            >
              We truly appreciate the time, effort, and interest you invested in applying to Inclusive World and encourage you to stay connected for future opportunities and upcoming application cycles.
            </div>
              ...
              <tr>
                <td style="padding:28px;">
                  ...
                  <div
                    ...
                    "
                  >
                    Thank you for your interest in Inclusive World and for taking the time to apply. We encourage you to apply again in future cycles as additional opportunities become available.
                  </div>
              ...
              <tr>
                <td style="padding:38px;">
                  ...
                  <div
                    ...
                    "
                  >
                    We sincerely appreciate your interest in Inclusive World and wish you continued success in your future endeavors.
                  </div>
